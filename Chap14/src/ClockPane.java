...
public class ClockPane extends Pane{
	...
	private void addNumbers() {
		Text text1 = new Text(this.getCenterX(),this.getCenterY()+ Math.min(width, length)*0.7/2,"12");
		Text text2 = new Text(this.getCenterX()+ Math.min(width, length)*0.7/2,this.getCenterY(),"3");
		Text text3 = new Text(this.getCenterX(),this.getCenterY()- Math.min(width, length)*0.7/2,"6");
		Text text4 = new Text(this.getCenterX()-Math.min(width, length)*0.7/2,this.getCenterY(),"9");
